...
function productTabs () {
    var productData = {
        'product-rigid-trucks.html': {
            title: 'Rigid Trucks',
            items: [
                { title: 'Tipper Bodies', slug: 'product-tipper-bodies.html', desc: 'Purpose-built tipper body solutions for rigid truck applications.' },
                { title: 'Platform', slug: 'product-platform.html', desc: 'Flat platform bodies designed for practical material movement.' },
                { title: 'Containers', slug: 'product-containers.html', desc: 'Container body solutions for secure and efficient transport.' }
            ]
        },
        'product-semi-trailers.html': {
            title: 'Semi-Trailers',
            items: [
                { title: 'Flatbed', slug: 'product-flatbed.html', desc: 'Open-deck trailer platform for versatile cargo movement.' },
                { title: 'Skeleton', slug: 'product-skeleton.html', desc: 'Lightweight skeletal trailer platform for container logistics.' },
                { title: 'Containerized Trailers', slug: 'product-containerized-trailers.html', desc: 'Container-focused trailers for reliable long-haul operations.' },
                { title: 'Semi Low Bed', slug: 'product-semi-low-bed.html', desc: 'Semi low bed trailer solution for heavy and oversized equipment.' },
                { title: 'Low Bed', slug: 'product-low-bed.html', desc: 'Low bed trailer platform for heavy-duty industrial transport.' },
                { title: 'Port Trailers', slug: 'product-port-trailers.html', desc: 'Trailer systems tailored for port and terminal operations.' },
                { title: 'Tipping Trailers', slug: 'product-tipping-trailers.html', desc: 'Tipping trailer solutions for bulk and construction material movement.' },
                { title: 'Sidewall Trailers', slug: 'product-sidewall-trailers.html', desc: 'Sidewall trailer configuration for stable cargo containment.' }
            ]
        },
    ...
    function makeSidebar(categorySlug, activeSlug) {
        ...
        if (category.items.length) {
            $.each(category.items, function(_, item) {
                ...
                html += '<li' + active + '><a href="' + productUrl(item.slug) + '">' + item.title + '</a></li>';
            });
        } else {
    ...
    function makeCards(categorySlug) {
        ...
        if (!category.items.length) {
            $('.product-detail-page .col-md-9').html(
                '<div class="product-detail-content"><h2>' + category.title + '</h2><h3>Coming Soon</h3></div>'
            );
            return;
        }
        ...
        $.each(category.items, function(_, item) {
            html += '<a class="product-list-card" href="' + productUrl(item.slug) + '">';
            html += '<span>Sub Product</span>';
    ...
    function showCategory(categorySlug) {
        ...
        $('.product-category-link').removeClass('active')
            .filter('[href$="#' + categorySlug + '"], [href="' + categorySlug + '"]').addClass('active');
    ...
    function showProduct(productSlug) {
        ...
        $('.product-detail-page .col-md-9').html(
            '<div class="product-detail-content"><h2>' + item.title + '</h2><h3>Coming Soon</h3></div>'
        );
        if (window.history && window.history.replaceState) {
    ...
    $(document).on('click', '.product-sidebar a, .product-list-card', function(e) {
